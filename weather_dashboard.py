...
# 温度预测描述
temp_forecast_min = forecast.min()
temp_forecast_max = forecast.max()
temp_forecast_trend = "上升" if forecast[-1] > forecast[0] else "下降"
forecast_desc = f"预计未来7天最低气温在{temp_forecast_min:.1f}°C ~ {temp_forecast_max:.1f}°C之间，整体呈{temp_forecast_trend}趋势。"
